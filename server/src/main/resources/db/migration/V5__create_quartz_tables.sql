-- =============================================================================
-- V5__create_quartz_tables.sql
-- Create Quartz Scheduler tables. When Flyway is enabled, Spring Boot 3 skips
-- auto-initialization of Quartz tables, so they must be explicitly managed by Flyway.
-- =============================================================================
